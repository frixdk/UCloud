...
export function injectFonts(): void {
    console.log(fontLight.default);
    const styleTag = document.createElement("style");
    styleTag.innerHTML = `
        /* Custom font */
        @font-face {
            font-family: 'IBM Plex Sans';
            src: url('${fontLight.default}');
            font-display: swap;
        }
