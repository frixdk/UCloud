...
import dk.sdu.cloud.file.orchestrator.api.SynchronizationProvider
...
@TSNamespace("file.ucloud.synchronization")
object UCloudSynchronization: SynchronizationProvider(UCLOUD_PROVIDER)
